...
function elimDeath(mode) {
    ...
    elimsPerDeath = browser.element(mode).element('data-category-id="overwatch.guid.0x08600000000003D2"').element('data-hero-guid="0x02E000000000012E"').getText('class="description"');
...
function weaponAccuracy(mode) {
    ...
    accuracy = browser.element(mode).element('data-category-id="overwatch.guid.0x086000000000002F"').element('data-hero-guid="0x02E000000000012E"').getText('class="description"');
...
describe('Get Sombra Stats', function () {
